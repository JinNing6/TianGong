...
def test_readmes_document_one_command_dev_install_and_quality_gate():
    ...
    for filename in ["README.md", "README.zh-CN.md"]:
        ...
        assert 'python -m pip install --upgrade "tiangong-mcp @ git+https://github.com/JinNing6/TianGong.git@v0.1.11"' in text
...
def test_readmes_put_current_candidate_install_before_stale_pypi_command():
    ...
    candidate = 'python -m pip install --upgrade "tiangong-mcp @ git+https://github.com/JinNing6/TianGong.git@v0.1.11"'
